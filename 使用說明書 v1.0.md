...
實驗系統提供完整的多 GPU 效能測試、實驗管理和結果比較功能。
...
# 自定義配置檔案
python tools/gpu_benchmark.py --config configs/my_gpu_configs.yaml

# 儲存結果
python tools/gpu_benchmark.py --output h100_benchmark.yaml
```

#### 測試結果解讀
```
=== H100 效能測試摘要 ===
Batch Size   Status       Time/Batch   Memory(GB)   FPS    
------------------------------------------------------------
256          成功          0.234s       8.45         1094.0
384          成功          0.298s       12.67        1288.6
512          成功          0.367s       16.89        1394.8
640          成功          0.445s       21.12        1438.2
768          失敗          記憶體不足
```
